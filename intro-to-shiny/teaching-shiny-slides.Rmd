...
---
# What is .code-background[`shiny`]?

`shiny` is an R package created 


---

# Why is it called .code-background[`shiny`]?
...
# Introduction: <br> A basic `shiny` app

---

## Demonstration of a simple .code-background[`shiny`] app
...
## Components of a .code-background[`shiny`] app
.pull-left[
.center[
### User interface
]

* This is a test of the infinite mood reader
* 
* 
]
...
A `shiny` web app is made up of:

* a _user interface_ (UI) function
* a _server_ function
...
.center[This structure can be implemented in two ways:]
...
NEED TO INSERT IMAGE OF HOW EACH TALKS TO THE OTHER

---

exclude: false

## A single file `shiny` app: *app.R*
...
Create new folder named "app_directory" with two files:
...
The files will contain the relevant functions:
.pull-left[
``` {r, eval = FALSE}
ui <- fluidPage( 
      . . .
...
`r countdown(minutes = 0.75, bottom = 0, play_sound =TRUE, warn_when = 30)`
