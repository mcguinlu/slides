...
knitr::include_graphics("figs/bias_papers.png")
```
...
Triangulation = extension of evidence synthesis
...
Predicting __extent and direction of bias__ can be difficult
...
Substantial further work needed to define __reasonable modifying distributions__ for bias terms

--

<br>

.center[**Need to move away from treating results included in a meta-analysis as if they were unbiased**]
