...
This is a paired forest plot - normal 

Produced using data from Hill et al analysis of 11 trials for ivermectin, an anti-parastic, on COVID-19 survival.

5 domains I mentioned on the last slide, plus one overall - 

Stratifying by risk of bias



Authors had the risk of bias data at the time of inital publication in early 2021

Ivermectin on COVID-19 survival

Shows that when stratifying by risk of bias the effect disappears when moving 
...
Example: text-mining to compare unadjusted and fully-adjusted results to obtain impact of insufficient control of confounding
